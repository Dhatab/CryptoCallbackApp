...
public class Fragment_Graph2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.graph2_fragment, container, false);
    ...
    private void makeChart() {
        ...
        StringRequest req = new StringRequest(Request.Method.GET, "https://min-api.cryptocompare.com/data/histohour?fsym=" + coinDesc + "&tsym=USD&limit=60&aggregate=3&e=CCCAGG",
        ...
        private void run(final ArrayList<String> xValues, ArrayList<Entry> Yvals1){
            {
                ...
                set1.setColor(Color.rgb(255,174,26));
                set1.setDrawCircles(true);
                set1.setLineWidth(3f);
                set1.setCircleRadius(1f);
                set1.setCircleColor(Color.rgb(255,174,26));
                set1.setFillAlpha(10);
                set1.setDrawFilled(true);
                Drawable drawable = ContextCompat.getDrawable(getContext(), R.drawable.fade_graph_frag3);
                ...
                IMarker marker = new Fragment_Graph2.YourMarkerView(getContext(),R.layout.custom_marker);
