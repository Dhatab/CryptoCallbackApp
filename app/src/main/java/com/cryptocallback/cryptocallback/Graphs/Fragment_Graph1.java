...
public class Fragment_Graph1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(coinDetailActivity.coinSymbol.equals("MIOTA")){
            coinDesc = "IOT";
        }else {
    ...
    private void makeChart() {
        ...
        StringRequest req = new StringRequest(Request.Method.GET, "https://min-api.cryptocompare.com/data/histominute?fsym=" + coinDesc + "&tsym=USD&limit=60&aggregate=24&e=CCCAGG",
